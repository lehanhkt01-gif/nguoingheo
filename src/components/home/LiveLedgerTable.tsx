...
const DEFAULT_TRANSACTIONS: TransactionItem[] = [
  ...
  },
  {
    ...
    type: "OUT",
    amount: 8000000,
    description: "Chi hỗ trợ xây nhà Đại đoàn kết đợt 1 cho bà Y Thị (Buôn Drai)",
    transactionDateTime: "2026-09-12T14:20:00Z",
    donorName: "Hộ bà Y Thị (Buôn Drai)",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    type: "OUT",
    amount: 5000000,
    description: "Cứu trợ sửa mái nhà dột nát Buôn Cổng",
    transactionDateTime: "2026-09-10T15:30:00Z",
    donorName: "Hộ A Hùng (Buôn Cổng)",
  },
  {
    id: 8,
