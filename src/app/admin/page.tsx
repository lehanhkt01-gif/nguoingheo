...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    // Tự động làm mới dữ liệu thời gian thực mỗi 15 giây
        ...
        <div className="bg-white rounded-2xl border border-blue-200/80 shadow-xs overflow-hidden">
          ...
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Phân hệ 2: Chế độ Đồng Bộ Hoàn Toàn Tự Động */}
              <div className="p-4 sm:p-5 rounded-xl bg-slate-50 border border-emerald-200/80 space-y-3.5 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-slate-800">
                        Chế độ Đồng Bộ: 100% Tự Động (Real-time)
                      </span>
                    </div>
                  ...
                  <div className="mt-3 p-3 rounded-lg bg-emerald-50/70 border border-emerald-200/80 space-y-2">
                    <div className="flex items-center justify-between text-xs font-bold text-emerald-950">
                      <span>Trạng thái kết nối Casso Open API:</span>
                      <span className="text-[10px] bg-emerald-200/80 text-emerald-900 px-2.5 py-0.5 rounded-full font-bold flex items-center gap-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-700 animate-pulse" />
                        Đang đồng bộ tự động thời gian thực
                      </span>
                    </div>

                    <div className="flex items-center justify-between pt-1 border-t border-emerald-200/60 text-xs text-emerald-900">
                      ...
                      <span className="font-mono font-extrabold text-emerald-900 text-sm">
                        {formatVND(cassoInfo?.liveAccount?.balance ?? stats.netBalance)}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2 pt-2">
                  <div className="p-3.5 rounded-xl bg-white border border-emerald-200 shadow-2xs space-y-2">
                    <div className="flex items-center gap-1.5 font-bold text-emerald-800 text-xs">
                      <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                      <span>Đã kích hoạt chế độ đồng bộ 100% tự động</span>
                    </div>
                    <ul className="text-[11px] text-slate-600 space-y-1.5 pl-1 leading-relaxed">
                      <li className="flex items-start gap-1.5">
                        <span className="text-emerald-600 font-bold">•</span>
                        <span><strong>Biến động số dư tức thì:</strong> Khi có phát sinh chuyển tiền vào/ra tài khoản BIDV 8630100930, hệ thống tự động tiếp nhận và ghi nhận ngay lập tức qua Webhook.</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="text-emerald-600 font-bold">•</span>
                        <span><strong>Cập nhật ngay lên Web:</strong> Danh sách sao kê trên Cổng thông tin công khai tự động làm mới theo thời gian thực (mỗi 10 giây) mà không cần can thiệp thủ công.</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="text-emerald-600 font-bold">•</span>
                        <span><strong>Đối soát bảo đảm:</strong> Cơ chế quét ngầm tự động đối soát trực tiếp với ngân hàng, đảm bảo khớp 100% không bỏ sót bất kỳ giao dịch nào.</span>
                      </li>
                    </ul>
                  </div>

                  <p className="text-[10px] text-slate-400 italic text-center">
                    (Đã tắt toàn bộ chế độ và nút bấm thao tác thủ công theo cấu hình tự động hóa)
                  </p>
                </div>
              </div>
            </div>
