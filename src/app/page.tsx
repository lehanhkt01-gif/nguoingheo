...
import { Heart, ArrowRight, BookOpen, CheckCircle } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-100 text-rose-800 text-xs font-semibold mb-2">
              ...
              <span>Nơi Gieo Hy Vọng - 20 Thôn Buôn</span>
            </div>
          ...
          <Link
            href="/chien-dich"
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-rose-700 hover:text-rose-800 self-start md:self-auto bg-rose-50 hover:bg-rose-100 px-4 py-2 rounded-xl transition-colors border border-rose-200"
          >
